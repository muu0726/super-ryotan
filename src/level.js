...
// 「一回きり」の踏み台を跳ね返り (vy=-5.0) で繋いで渡る超高難易度ステージ。
// 跳ね返りの到達範囲は同じ高さで約4.2タイル・上昇約44px (1.4タイル) なので、
// 同列は4タイル間隔、1行上への乗り継ぎは3タイル間隔で配置している。
// H+# の壁 (col 23/52/68) はジャンプ長押し + パタパタが浮遊の上側にいる
// タイミングで跳ね返らないと越えられない。
