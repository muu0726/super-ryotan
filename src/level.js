...
// 大ジャンプの到達範囲は同じ高さで約6.3タイル・上昇約93px (2.9タイル)。
// 足場は4タイル間隔で、通常ジャンプでの乗り継ぎに対して余裕がある。
...
const LEVEL_EX = [
  ...
  D(23) + '#' + D(18) + 'o' + D(9) + '#' + D(15) + '#' + D(8) + 'o',
  D(13) + '=' + D(3) + '=' + D(3) + 'F' + D(3) + '=' + D(3) + '=' + D(3) + '===' + D(3) + '=' +
    D(10) + 'F' + D(3) + '=' + D(3) + '=====' + D(3) + 'F' + D(3) + '=' + D(3) + '=' +
    D(9) + '=' + D(3) + '=' + D(3) + '=' + D(3) + '=',
  D(3) + 'S' + D(97) + 'G',
  LEX_GROUND,
  LEX_GROUND,
